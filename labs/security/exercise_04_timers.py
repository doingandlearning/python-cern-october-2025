...
This exercise introduces timer-based threading for scheduled tasks,
similar to the timer_example.py but in a security context.

Learning Objectives:
- Use Timer threads for delayed execution
- Create periodic/repeating tasks
- Schedule security checks and alerts
- Understand timer-based patterns

Task: Add timer-based features to the security system including
periodic status checks and scheduled alerts.
"""
...
def main():
    ...
    # TODO: Create a one-time alert timer (3 seconds delay)
    alert_timer = threading.Timer(3.0, security_alert)
    alert_timer.start()
    
    # TODO: Start periodic status checks
    periodic_status_check()
    
    # TODO: Create and start door sensor thread
    door_thread = threading.Thread(target=door_sensor, args=("DOOR-001", 15))
    door_thread.start()
    
    # TODO: Run the system for 15 seconds
    print("System running for 15 seconds...")
    time.sleep(15)
    
    # TODO: Wait for door sensor to complete
    door_thread.join()
