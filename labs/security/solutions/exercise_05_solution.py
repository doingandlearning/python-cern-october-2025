"""
Exercise 5 Solution: Thread Synchronization with Locks
======================================================

Complete solution demonstrating thread synchronization.
"""
...
def log_event(event_type, message):
    ...
    # Use the log_lock to protect file writing
    with log_lock:
...
def update_security_state(key, value):
    ...
    """
    # Use state_lock to protect shared state updates
    with state_lock:
...
def motion_sensor(sensor_id):
    ...
    for i in range(6):
        ...
        if motion_detected:
            # Log motion detection thread-safely
...
def system_controller():
    ...
    # Disarm the system after 10 seconds
    time.sleep(7)
