people = [("Darja", 25), ("Patricio", 17), ("Cedric", 23), ("Clement", 24)]


def get_second_value_from_tuple(tup):
    return tup[1]


sorted_people = sorted(people, key=get_second_value_from_tuple)
sorted_people_two = sorted(people, key=lambda x: len(x[0]))
sorted_people_two = sorted(people, key=lambda x: x[1], reverse=True)
print(sorted_people)
print(sorted_people_two)

temperatures = [{"city": "London", "temp": 12},
                {"city": "Rome", "temp": 19},
                {"city": "Geneva", "temp": 15}
                ]


def get_temperature_from_dict(dictionary):
    return dictionary["temp"]


temps_only_one = [x["temp"] for x in temperatures]
temps_only_one = [get_temperature_from_dict(x) for x in temperatures]
print(temps_only_one)

temps_only_two = list(map(lambda x: x["temp"], temperatures))
temps_only_two = list(map(get_temperature_from_dict, temperatures))
print(temps_only_two)

numbers = [5, 12, 17, 3, 9]


def is_in_range_five_to_fifteen(x):
    if 5 < x < 15:
        return x


numbers_in_range = [n for n in numbers if 5 < n < 15]
# numbers_in_range = [is_in_range_five_to_fifteen(n) for n in numbers]
print(numbers_in_range)

numbers_in_range_two = list(filter(lambda x: 5 < x < 15, numbers))
numbers_in_range_two = list(filter(is_in_range_five_to_fifteen, numbers))

print(numbers_in_range_two)

ditto_data = {"abilities": [
    ...
    "forms": [{"name": "ditto", "url": "https://pokeapi.co/api/v2/pokemon-form/132/"}], "game_indices": [
        {"game_index": 76, "version": {"name": "red", "url": "https://pokeapi.co/api/v2/version/1/"}},
        {"game_index": 76, "version": {"name": "blue", "url": "https://pokeapi.co/api/v2/version/2/"}},
        ...
        {"game_index": 132, "version": {"name": "leafgreen", "url": "https://pokeapi.co/api/v2/version/11/"}},
        {"game_index": 132, "version": {"name": "diamond", "url": "https://pokeapi.co/api/v2/version/12/"}},
        ...
        {"game_index": 132, "version": {"name": "heartgold", "url": "https://pokeapi.co/api/v2/version/15/"}},
        {"game_index": 132, "version": {"name": "soulsilver", "url": "https://pokeapi.co/api/v2/version/16/"}},
    ...
    "height": 3, "held_items": [
        {"item": {"name": "metal-powder", "url": "https://pokeapi.co/api/v2/item/234/"},
         "version_details": [{"rarity": 5, "version": {"name": "ruby", "url": "https://pokeapi.co/api/v2/version/7/"}},
                             {"rarity": 5,
                             ...
                             {"rarity": 5,
                              "version": {"name": "ultra-moon", "url": "https://pokeapi.co/api/v2/version/30/"}}]},
        {"item": {"name": "quick-powder", "url": "https://pokeapi.co/api/v2/item/251/"}, "version_details": [
            {"rarity": 50, "version": {"name": "diamond", "url": "https://pokeapi.co/api/v2/version/12/"}},
            {"rarity": 50, "version": {"name": "pearl", "url": "https://pokeapi.co/api/v2/version/13/"}},
            ...
            {"rarity": 50, "version": {"name": "alpha-sapphire", "url": "https://pokeapi.co/api/v2/version/26/"}},
            {"rarity": 50, "version": {"name": "sun", "url": "https://pokeapi.co/api/v2/version/27/"}},
    ...
    "id": 132, "is_default": True,
    "location_area_encounters": "https://pokeapi.co/api/v2/pokemon/132/encounters", "moves": [
        {"move": {"name": "transform", "url": "https://pokeapi.co/api/v2/move/144/"}, "version_group_details": [
            {"level_learned_at": 1,
             "move_learn_method": {"name": "level-up", "url": "https://pokeapi.co/api/v2/move-learn-method/1/"},
             "order": None, "version_group": {"name": "red-blue", "url": "https://pokeapi.co/api/v2/version-group/1/"}},
            {"level_learned_at": 1,
             "move_learn_method": {"name": "level-up", "url": "https://pokeapi.co/api/v2/move-learn-method/1/"},
             "order": None, "version_group": {"name": "yellow", "url": "https://pokeapi.co/api/v2/version-group/2/"}},
            {"level_learned_at": 1,
             "move_learn_method": {"name": "level-up", "url": "https://pokeapi.co/api/v2/move-learn-method/1/"},
             "order": None,
            ...
            {"level_learned_at": 1,
             "move_learn_method": {"name": "level-up", "url": "https://pokeapi.co/api/v2/move-learn-method/1/"},
             "order": None, "version_group": {"name": "crystal", "url": "https://pokeapi.co/api/v2/version-group/4/"}},
            {"level_learned_at": 1,
             "move_learn_method": {"name": "level-up", "url": "https://pokeapi.co/api/v2/move-learn-method/1/"},
             "order": None,
            ...
            {"level_learned_at": 1,
             "move_learn_method": {"name": "level-up", "url": "https://pokeapi.co/api/v2/move-learn-method/1/"},
             "order": None, "version_group": {"name": "emerald", "url": "https://pokeapi.co/api/v2/version-group/6/"}},
            {"level_learned_at": 1,
             "move_learn_method": {"name": "level-up", "url": "https://pokeapi.co/api/v2/move-learn-method/1/"},
             "order": None,
            ...
            {"level_learned_at": 1,
             "move_learn_method": {"name": "level-up", "url": "https://pokeapi.co/api/v2/move-learn-method/1/"},
             "order": None, "version_group": {"name": "platinum", "url": "https://pokeapi.co/api/v2/version-group/9/"}},
            {"level_learned_at": 1,
             "move_learn_method": {"name": "level-up", "url": "https://pokeapi.co/api/v2/move-learn-method/1/"},
             "order": None,
            ...
            {"level_learned_at": 1,
             "move_learn_method": {"name": "level-up", "url": "https://pokeapi.co/api/v2/move-learn-method/1/"},
             "order": None, "version_group": {"name": "xd", "url": "https://pokeapi.co/api/v2/version-group/13/"}},
            {"level_learned_at": 1,
             "move_learn_method": {"name": "level-up", "url": "https://pokeapi.co/api/v2/move-learn-method/1/"},
             "order": None,
            ...
            {"level_learned_at": 1,
             "move_learn_method": {"name": "level-up", "url": "https://pokeapi.co/api/v2/move-learn-method/1/"},
             "order": None, "version_group": {"name": "x-y", "url": "https://pokeapi.co/api/v2/version-group/15/"}},
            {"level_learned_at": 1,
             "move_learn_method": {"name": "level-up", "url": "https://pokeapi.co/api/v2/move-learn-method/1/"},
             "order": None, "version_group": {"name": "omega-ruby-alpha-sapphire",
            ...
            {"level_learned_at": 1,
             "move_learn_method": {"name": "level-up", "url": "https://pokeapi.co/api/v2/move-learn-method/1/"},
             "order": None, "version_group": {"name": "lets-go-pikachu-lets-go-eevee",
            ...
            {"level_learned_at": 1,
             "move_learn_method": {"name": "level-up", "url": "https://pokeapi.co/api/v2/move-learn-method/1/"},
             "order": None, "version_group": {"name": "brilliant-diamond-and-shining-pearl",
    ...
    "name": "ditto", "order": 214, "past_abilities": [
        {"abilities": [{"ability": None, "is_hidden": True, "slot": 3}],
         "generation": {"name": "generation-iv", "url": "https://pokeapi.co/api/v2/generation/4/"}}], "past_types": [],
    "species": {"name": "ditto", "url": "https://pokeapi.co/api/v2/pokemon-species/132/"}, "sprites": {
        ...
        "front_shiny_female": None, "other": {"dream_world": {
            ...
            "front_shiny_female": None}, "official-artwork": {
            ...
            "showdown": {
                ...
                "front_shiny_female": None}}, "versions": {"generation-i": {
            "red-blue": {
...
ditto_sprites = ditto_data["sprites"].values()
ditto_sprites = [x for x in ditto_sprites if x is not None]

print(ditto_sprites)
ditto_sprites = ditto_data["sprites"].values()
ditto_sprites = list(filter(lambda x: x is not None, ditto_sprites))
print(ditto_sprites)